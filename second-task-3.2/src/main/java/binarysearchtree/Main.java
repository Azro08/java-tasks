...
public class Main {
    public static void main(String[] args) {
        ...
        int compares = binaryTree.optCompares(treeSize);
        StdOut.println("For a binary search tree with " + treeSize + " nodes, the number of compares to reach an optimal placement of null links is " + compares + ".");
